...
class Sheep:
    ...
    def shearing(self):
        print(f'Вы постригли {self.name}')
...
koko_hen = Chicken('Чернушка', 8)
kuka_hen = Chicken('пеструшка', 5)
goat_0 = Goat('Рога', 37)
goat_1 = Goat('Копыта', 38)
duck_girl = Duck('Клавдет', 3)
duck_boy = Duck('Масао', 3.5)

animals = [grey_goose, white_goose, cow, barashek, kudryash, koko_hen, kuka_hen, goat_0, goat_1, duck_girl, duck_boy]
common_sum = 0
max_weight = 0
max_weight_name = ""
